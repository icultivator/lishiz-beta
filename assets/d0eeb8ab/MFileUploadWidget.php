...
class MFileUploadWidget extends CInputWidget
{
    ...
    public function init()
    {
        ...
        $cs->registerScriptFile($this->assetsUrl.'/js/jquery.ui.widget.js', CClientScript::POS_READY);
        $cs->registerScriptFile($this->assetsUrl.'/js/jquery.iframe-transport.js', CClientScript::POS_READY);
        $cs->registerScriptFile($this->assetsUrl.'/js/jquery.fileupload.js', CClientScript::POS_READY);
    }
