...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/fix.css" />
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'User','url'=>array('user/'.Yii::app()->user->id),'visible'=>!Yii::app()->user->isGuest),
