...
class AskController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','follow','vote'),
				'users'=>array('@'),
			),
	...
	public function actionView($id)
	{
        ...
        $criteria->condition = 'status = :status AND obj_type = :type AND obj_id = :aid';
        $criteria->params = array(':status'=>$model::ASK_PUBLISHED,':type'=>$obj_type,':aid'=>$id);
